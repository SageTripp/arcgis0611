...
/**
 * Created by Administrator on 2018/5/4. by lbc
 */
//
...
//        mapControl.showCompass(0, 180, ((BitmapDrawable)App.getInstance().getResources().getDrawable(R.drawable.compass)).getBitmap());
        //以下代码可使得地图双指旋转  // by lbc
        mapControl.setPanTool(false, 0);//by lbc
        if (mapControl.getMap() == null)// by lbc
        {
            ...
            mapControl.loadMap(path + "/ucmap/bj2/map.ini", (byte) 0);
            //MapLoader.loadMapXML(mapControl, Environment.getExternalStorageDirectory().getPath()+"/tianditu.xml");
