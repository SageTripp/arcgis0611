...
public class NoUseLand {
	  public Integer TotalNums;//未利用地总地块数
	    public Double TotalArea;//未利用地总面积
	    public String TotalText;//未利用地统计文本
	    public String LandTypeText;//未利用地各类用地各地类文本
