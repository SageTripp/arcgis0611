...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected final static float TITLE_MARGIN_FRACTION = 0.10F;
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        for (int i = 0; i < mModels.size(); i++) {
            ...
            if (mIsHorizontalOrientation) {
                ...
                topTitleOffset = topOffset +  (model.mIcon.getHeight() + iconMarginTitleHeight) * 0.35f;
            }
            ...
            StaticLayout staticLayout = new StaticLayout(
                    ...
                    new TextPaint(mModelTitlePaint),
                    mTitlesCanvas.getWidth(),
...
//                        mModelTitlePaint
//                );
                mTitlesCanvas.translate(leftTitleOffset,topTitleOffset);
                staticLayout.draw(mTitlesCanvas);
                mTitlesCanvas.translate(-leftTitleOffset,-topTitleOffset);
            }
        }
